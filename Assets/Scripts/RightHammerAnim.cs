...
public class RightHammerAnim : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Frame initialFrame = new Frame(new Vector3(baseObject.transform.position.x, 0f, baseObject.transform.position.z), Quaternion.Euler(new Vector3(0f, 0f, 0f)), new Vector3(1f, 1f, 1f), baseTransform.gameObject);
        frames = new List<Frame>();
        frames2 = new List<Frame>();
        frames.Add(initialFrame);
        frames.Add(initialFrame);
        Frame initialHammerFrame = new Frame(new Vector3(hammerPart.transform.position.x, 0f, hammerPart.transform.position.z), Quaternion.Euler(new Vector3(0f, 0f, 0f)), new Vector3(1f, 1f, 1f), hammerTransform.gameObject);
    ...
    public void ResetAnimation(Vector3 newPos) {
        ...
        Frame initialFrame = new Frame(new Vector3(newPos.x, 0f, newPos.z), Quaternion.Euler(new Vector3(0f, 0f, 0f)), new Vector3(1f, 1f, 1f), baseTransform.gameObject);
        frames = new List<Frame>();
        frames2 = new List<Frame>();
        frames.Add(initialFrame);
        frames.Add(initialFrame);
        Frame initialHammerFrame = new Frame(new Vector3(newPos.x, 0f, newPos.z), Quaternion.Euler(new Vector3(0f, 0f, 0f)), new Vector3(1f, 1f, 1f), hammerTransform.gameObject);
        frames2.Add(initialHammerFrame);
        frames2.Add(initialHammerFrame);
        float y = initialFrame.position.y;
        float rotChange = 0.1f;
