...
public class RiserAnim : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Frame coloredFrame = new Frame(new Vector3(coloredPart.transform.position.x, 11.55f, coloredPart.transform.position.z), Quaternion.identity, new Vector3(0.45f, 0.9f, 0.45f), coloredTransform.gameObject);
